    ...
    try {
      ...
      if (error.response?.status === 400) {
        if (
          ...
          "Kategori ini sudah memiliki perencanaan"
        ) {
          alert(
            "Kategori ini sudah memiliki perencanaan. Silakan pilih kategori lain atau edit rencana yang sudah ada."
          );
        } else {
        ...
        alert(
          "Terjadi kesalahan saat menyimpan perencanaan. Silakan coba lagi."
        );
      }
    }
  };
                ...
                <div className="plans-grid">
                  {plans.length === 0 ? (
                    <div className="no-plans">
                      Belum ada perencanaan keuangan. Silakan tambahkan
                      perencanaan baru.
                    </div>
                  ) : (
                    plans.map((plan) => (
                      <div key={plan.id} className="plan-card">
                        ...
                        <div className="plan-details">
                          ...
                          <div className="detail-row">
                            ...
                            <span className="value">
                              Rp{" "}
                              {Number(plan.remainingAmount).toLocaleString(
                                "id-ID"
                              )}
                            </span>
                          </div>
